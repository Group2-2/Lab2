...
public class ModelImpl implements Model {
    ...
    /**
     * возвращает атрибут  type
     * @return
     * @param command
     */
    public String getTypeOfTheCommand(String command) {
        return null;
    }

    /**
     * Возвращает атрибут sender
     *
     * @param command*/
    ...
    /**
     * Вернуть атрибут юзер, но слишком много юзеров, можер реально перенести в другой класс методы связанные с парсингом
     * @return
     */
    ...
    /**
     *
     * String.format("<command type=\"ban\" user = \"%s\" result = \"ACCEPTED\"/>", login)
     * @param type - тип комманды, ban/unban
     * @param user - user
     * @param isAccepted ACCEPTED
     * @return
     */
    public String result(String type, String user, boolean isAccepted) {
        return null;
    }
    ...
    public String getPass(String command) {
        return null;
    }

    /**
     * Если в параметре null - пустая строка - в булевых нельзя налл, значит сразу сделай на исАссептед проверку
     * "<command type=\"login\" result = \"NOTACCEPTED\"/>";
     * @param type
     * @param name
     * @param Isadmin
     * @param IsinBan
     ...
     * @return
     */
    public String resultForLoginRegister(String type, String name, boolean Isadmin, boolean IsinBan, boolean isAccepted) {
        return null;
    }
    ...
    public String getTextAttr(String command) {
        return null;
    }

    public String getNameCommand(String command) {
        return null;
    }
}
